		...
		<div class="d-flex flex-column">
			...
			@if (isset($postsFromFollowers))
				<div class="mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-30 bd-bottom">
                        <span class="block-title pb-20">
                            <a href="{{ route('posts.followers') }}" class="font-size-20 font-weight-bold text-dark text-dark-hover" title="Today's top posts">Posts from followers</a>
                        </span>
            ...
            <div class="mb-30">
                <div class="d-flex justify-content-between align-items-center mb-30 bd-bottom">
                    <span class="block-title pb-20">
                        <a href="{{ route('recommendation') }}" class="font-size-20 font-weight-bold text-dark text-dark-hover" title="You might like">You might like</a>
                    </span>
            ...
            @if (count($exploreMoreTopics) > 0)
                <div class="mb-30">
                    <div class="d-flex justify-content-between align-items-center bd-bottom mb-30">
                        <span class="block-title pb-20">
                            <a href="{{ route('topics') }}" class="font-size-20 font-weight-bold text-dark text-dark-hover" title="Explore more topics">Explore more topics</a>
                        </span>
