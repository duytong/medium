                ...
                <div class="mr-auto">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('categories.index') }}">Tags</a>
                            </li>
                            ...
                            <form action="{{ route('tags.store') }}" method="POST" class="m-form m-form--fit m-form--label-align-right">
                                ...
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        <label>Name</label>
                                        <input type="text" class="form-control m-input" name="name" placeholder="Enter tag name" value="{{ old('name') }}" required autofocus autocomplete="off">
                                        @if ($errors->has('name'))
