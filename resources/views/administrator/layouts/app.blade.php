...
<html>
    <head>
        ...
        <base href="{{ asset('') }}">
        <link rel="stylesheet" href="assets/administrator/css/vEndors.bundle.css">
    ...
    <body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
        ...
        <script src="assets/administrator/js/vEndors.bundle.js"></script>
        <script src="assets/administrator/js/main.min.js"></script>
        <script src="assets/administrator/js/select2.min.js"></script>
        @yield('script')
