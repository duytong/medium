                ...
                <div class="m-portlet__body">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            @endif
                            <form action="{{ route('topics.store') }}" method="POST" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="text" class="form-control m-input" name="overview" placeholder="Enter overview" value="{{ old('overview') }}" required autocomplete="off">
                                    ...
                                    <div class="form-group m-form__group">
                                        <label>Image</label>
                                        <input type="file" class="d-block" name="image" required style="outline: none">
                                        @if ($errors->has('image'))
