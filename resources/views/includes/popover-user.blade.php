<div class="font-size-12 text-default">
    <div class="pb-2">
        <div class="d-flex mb-8">
            ...
            <div class="d-flex flex-column justify-content-center pl-3">
                <h4 class="font-size-18 font-weight-bold">
        ...
        <div>{{ _substr($post->user->summary, 100) }}</div>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center pt-2">
        ...
        @login
            ...
            @endif
        @else
            <button class="btn btn-success font-size-12" data-toggle="modal" data-target="#signin-modal">Follow</button>
        @endlogin
    </div>
</div>