@extends('layouts.app')
@section('title', 'Latest posts about ' . $tag->name . ' - Medium')
@section('content')
	<div class="my-5">
		...
		<div class="row mt-5">
			...
			<div class="col-lg-8">
				<div class="d-flex bd-bottom mb-4">
					<div class="pb-3 mr-4">
						<a href="{{ route('tag.show', $tag->slug) }}" class="text-default text-default-hover">Top posts</a>
					</div>
					<div class="block-title pb-3">
						<a href="{{ route('tag.latest', $tag->slug) }}" class="text-dark">Latest</a>
					</div>
				</div>
