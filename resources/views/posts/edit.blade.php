                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="mt-4">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" id="title" class="form-control px-0 bd-none font-size-40 font-weight-bold text-dark" name="title" placeholder="Title" autofocus autocomplete="off" value="{{ $post->title }}">
                            </div>
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-center form-group">
                                @if (!empty($post->image))
                                    <div class="mb-2" id="file-name">{{ $post->image }}</div>
                                @else
