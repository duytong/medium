@extends('layouts.app')
@section('title', 'Followers of ' . $profile->name . ' - Medium')
@section('content')
			...
			<div class="my-5">
				...
				@else
					@if ($profile->id == auth()->user()->id)
						<div class="font-size-20 text-dark text-center mt-5">You doesn't have followers.</div>
					@else
						<div class="font-size-20 text-dark text-center mt-5">{{ $profile->name }} doesn't have followers.</div>
					@endif
				@endif
			</div>
		</div>
